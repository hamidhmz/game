										...
										<div class="col-sm-12">
											<div class="center">
												<span class="btn btn-app btn-sm btn-light no-hover">
													...
													<br />
													<span class="line-height-1 smaller-90">جمع هزینه پرداخت نشده</span>
												</span>

												<span class="btn btn-app btn-sm btn-yellow no-hover">
													<span class="line-height-1 bigger-170">
														<?php
															$sql="SELECT COUNT(id) as tid FROM tmpuser";
														    $result=$connect->query($sql);
													...
													<br />
													<span class="line-height-1 smaller-90">کل کاربران</span>
												</span>
												...
												<span class="btn btn-app btn-sm btn-pink no-hover">
													...
													<br />
													<span class="line-height-1 smaller-90">تماس پاسخ داده نشده</span>
												</span>
												...
												<span class="btn btn-app btn-sm btn-grey no-hover">
													...
													<br />
													<span class="line-height-1 smaller-90">کل پول مبحوس در بازی</span>
												</span>
												...
												<span class="btn btn-app btn-sm btn-success no-hover">
													...
													<br />
													<span class="line-height-1 smaller-90">تعداد تراکنش ها</span>
												</span>
										...
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="widget-title lighter smaller">
													<i class="ace-icon fa fa-bar-chart-o orange"></i>فعالیت های روزانه
												</h4>
											</div>
													...
													<div class="dialogs">
														<div class=" padding-8">
															...
															<table id="dynamic-table" class="table table-striped table-bordered table-hover">
																...
																<tbody>
																	<?php
																		$sql = "SELECT * FROM dayli ORDER BY `id` DESC   ";
																		$result = $connect->query($sql);
																		while ($fetch = $result->fetch(PDO::FETCH_ASSOC)) {
																	?>
																	<tr>
																		...
																		<td class=""><?php
																			...
																			echo number_format($pluse);
																		?></td>
																		<td>
																			<?php
																				$pluse = 0;
																				$sqlp1 = "SELECT * FROM tmpgetmoney WHERE year=:year AND month=:month AND day=:day  ";
																				$resultp1 = $connect->prepare($sqlp1);
																				$resultp1 -> bindvalue(":year",$fetch['year']);
																				$resultp1 -> bindvalue(":month",$fetch['month']);
																				$resultp1 -> bindvalue(":day",$fetch['day']);
																		...
																		<td>
																			<?php
																				$pluse = 0;
																				$sqlp1 = "SELECT COUNT(id) as dd FROM tmpuser WHERE year=:year AND month=:month AND day=:day  ";
																				$resultp1 = $connect->prepare($sqlp1);
																				$resultp1 -> bindvalue(":year",$fetch['year']);
																				$resultp1 -> bindvalue(":month",$fetch['month']);
																				$resultp1 -> bindvalue(":day",$fetch['day']);
																		...
																		<td>
																			<a href="daily/?id=<?= $fetch['id']?>" class="btn btn-xs btn-primary">نمایش جزییات</a>
																		</td>
																	</tr>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							...
							<a href="" target="blank">tmpiran</a>  &copy; 2016-2017
						</span>
