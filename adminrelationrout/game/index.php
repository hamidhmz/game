				...
				<ul class="nav nav-list">
					...
					<li class="active open">
						<a href="#" class="dropdown-toggle">
							...
							<span class="menu-text"> صفحات دیگر </span>
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									ویرایش متن صفحه ی <span class="green">بازی</span> در سایت
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h4 class="header dark clearfix">
									برای تغییر متن در صفحه <span class="blue">بازی </span> متن خود را وارد کنید .
								</h4>
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="input-group">
											...
											<input type="text" id="caption" class="form-control search-query" style="direction: rtl" value=
												<?php
													$sql="select * from topic where page=3 && position=1;";
												    $result=$connect->query($sql);
												    $fetch=$result->fetch(PDO::FETCH_ASSOC);
												    if (isset($fetch['caption'])) 
												    {
												    	echo "'";
												    	echo $fetch['caption'];
												    	echo "'";
											...
											<span class="input-group-btn">
												<div  class="btn btn-info btn-sm">
													<span class="ace-icon fa fa-arrow-left icon-on-left bigger-110"></span>
													تیتر را در این قسمت وارد کنید 
												</div>
											</span>
										</div>
