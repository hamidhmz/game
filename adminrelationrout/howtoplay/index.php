						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									ویرایش متن صفحه ی <span class="green">نحوه ی شروع بازی</span> در سایت
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h4 class="header green clearfix">
									برای تغییر متن در صفحه <span class="blue">آموزش پوکر</span> متن خود را وارد کنید .
								</h4>
										...
										<div class="widget-box widget-color-green">
											...
											<div class="widget-body">
												<div class="widget-main no-padding">
													<div class="wysiwyg-editor editor2" id="editor2">
														<?php
												...
												<div class="widget-toolbox padding-4 clearfix">
													...
													<div class="btn-group pull-right">
														...
														<button id="save" class="btn btn-sm btn-success btn-white btn-round">
							...
							<div class="row">
								<div class="col-xs-12">
									<!-- PAGE CONTENT BEGINS -->
									<h4 class="header green clearfix">
										برای تغییر متن در صفحه <span class="blue">آموزش بازی با ماونز</span> متن خود را وارد کنید .
									</h4>
									...
									<div class="row">
										<div class="col-sm-12">
											...
											<div class="widget-box widget-color-green">
												...
												<div class="widget-body">
													<div class="widget-main no-padding">
														<div class="wysiwyg-editor editor2" id="editor1">
															<?php
													...
													<div class="widget-toolbox padding-4 clearfix">
														...
														<div class="btn-group pull-right">
															...
															<button id="save1" class="btn btn-sm btn-success btn-white btn-round">
																<i class="ace-icon fa fa-globe bigger-125"></i>
    ...
    $(this).css({'direction':'rtl'});
		...
		<script type="text/javascript">
		    ...
		    $("#save").click(function(){
		        ...
		        $.post("edit.php",{matn:matn,btn:btn},function(data){$("#txt").html(data);});
		        });
		    });
	    </script>
	    <script type="text/javascript">
		    ...
		    $("#save1").click(function(){
		        ...
		        var btn1="save1";
		        var matn=$('#editor1').html();
		        $.post("edit.php",{matn:matn,btn1:btn1},function(data){$("#txt1").html(data);});
		        });
		    });
	    </script>
	</body>
