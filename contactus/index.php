                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                            ...
                            <div class="navbar-default in-xs sidebar" role="navigation">
                                <div class="sidebar-nav navbar-collapse">
                                    <ul class="nav" id="">
                                        ...
                                        <li>
                                            <a href="" class="active" data-toggle = "tooltip" data-placement = "bottom" title = " info"><i class="fa fa-phone fa-fw"></i>  تماس با ما </a>

                                        </li>
                                        <li>
                                            <a href="ticket/"  data-toggle = "tooltip" data-placement = "bottom" title = " Rack Back "><i class="fa fa-send-o fa-fw"></i>  ارسال تیکت </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-7 pull-right" style="margin: 10px auto;">
                                <form role="form rtl" method="get" action="sendmessage.php">
                                    <div class="form-group rtl">
                                        <label>نام شما</label>
                                        <input name="name" class="form-control" style="width: 50%" type="text" value="<?= $_COOKIE['tmpname'];?>">
                                    </div>
                                    <div class="form-group rtl">
                                        <label>ایمیل شما</label>
                                        <input name="email" class="form-control" style="width: 50%" type="text" placeholder="ایمیل خود را وارد کنید ">
                                    </div>
                                    <div class="form-group rtl">
                                        <label>متن پیام</label>
                                        <textarea name="text" class="form-control" placeholder="متن پیام خود را وارد کنید" style="width: 70%" rows="8"></textarea>
                                    </div>
                                    <div class="form-group rtl">
                                        <input name="submit" type="submit" class="btn btn-info" value="ارسال پیام" name="">
                                    </div>
                                </form>
                            </div>
                            <div class="col-xs-12 col-sm-5 pull-right" style="margin: 10px auto;">
                                <div class="panel panel-default">
                                     <div class="panel-heading rtl">
                                        <h5>کانال های ارتباطی ما</h5>
                                    </div>
                                        ...
                                        <div class="center rtl">
                                            ...
                                            <?php
                                                ...
                                                while($fetch=$result->fetch(PDO::FETCH_ASSOC)){
                                                    ?>
                                                <li class="social-link"><a href="<?= $fetch['instagram'];?>" class=""><i class="fa fa-instagram  purper"></i>  اینستاگرام ما</a></li>
                                                <li class="social-link"><a href="<?= $fetch['telegram']?>" class=""><i class="fa fa-telegram  blue"></i>  کانال تلگرامی ما</a></li>
                                                <li class="social-link"><a href="<?= $fetch['twitter']?>" class=""><i class="fa fa-telegram  blue"></i>  تلگرام مدیریت</a></li>
                                            <?php
                                                }
                                            ?>
                                            </ul>
