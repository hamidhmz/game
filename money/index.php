...
<body >
            ...
            <div class="navbar-default sidebar " >
                ...
                <div class="sidebar-nav  " >
                    <ul class="nav" id="">
                        ...
                        <li>
                            <a href="../money" class="active" data-toggle = "tooltip" data-placement = "bottom" title = " Cash out "><i class="fa fa-credit-card fa-fw"></i> برداشت وجه</a>
    ...
    <div id="wrapper" >
     ...
     <div class="container">
        <div id="page-wrapper " class="xs30md10" style="">
             <div class="row">
            ...
            <?php
                $who = $_COOKIE['tmpname'];
                $sqlp1="select * from tmpuser where username=:user ";
                $resultp1=$connect->prepare($sqlp1);
                $resultp1->bindvalue(":user",$who);
                $resultp1->execute();
        ...
        { ?>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading rtl">
                        لطفا برای انتقال پول به مواردزیر توجه کنید .
                        </div>
                        <div class="panel-body rtl">
                            <div class="row">
                               <p>
                                  شما تا زمان واریز وجه، فقط میتوانید یک درخواست برداشت ثبت کنید. لطفا برای افزایش مبلغ برداشت، درخواست قبلی خود را لغو کنید سپس مبلغ را افزایش دهید و دوباره درخواست خود را ثبت کنید.
                               </p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading rtl">
                            لطفا برای انتقال پول موارد زیر را تکمیل نمایید .
                        </div>
                        <div class="panel-body">
                            <div class="row">

                                <div class="col-sm-12">
                                    <form role="form" method="post" action="getmoney.php" style="margin-top: 20px;">
                                        <fieldset >

                                            <div class='form-group rtl'>
                                                <label for='moneycount'>مبلغ برداشتی به تومان</label>
                                                <input name='Mount' class='form-control' id='moneycount' type='text' style='width: 55%' placeholder='مبلغ برداشتی ' >
                                            </div>
                                            <input name='Submit' type='submit' value='درخواست برداشت' class='btn btn-primary pull-right'>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table  class="table table-bordered responsive-table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>نام دارنده ی حساب</th>
                                                <th>شماره کارت حساب</th>
                                                <th>شماره شبای حساب</th>
                                            </tr>
                                        </thead>
                                        <?php
                                        $who = $_COOKIE['tmpname'];
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>#</td>
                                                <td>
                                                    <span><?= $fetch['acountrealname'] ?></span>
                                                </td>
                                                <td>
                                                    <span><?= $fetch['acount'] ?></span>
                                                </td>
                                                <td>
                                                    <span><?php if($fetch['shaba']==0){echo "شماره شبا وارد نشده";}else{echo $fetch['shaba'];}?></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table id="dynamic-table" class="bordered striped responsive-table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>مبلغ برداشتی (تومان)</th>
                                                <th class="hidden-xs">تاریخ</th>
                                                <th class="hidden-xs">نام دارنده حساب</th>
                                                <th class="hidden-xs">شماره کارت</th>
                                                <th>شماره شبا</th>
                                                <th>وضعیت </th>
                                        ...
                                        <?php
                                            $who = $_COOKIE['tmpname'];
                                            $sql="select id from tmpuser where username=:user ";
                                            $result=$connect->prepare($sql);
                                            $result->bindvalue(":user",$who);
                                            $result->execute();
                                            $fetch=$result->fetch(PDO::FETCH_ASSOC);
                                            $id = $fetch['id'];
                                            $sql="select * from tmpgetmoney where id_user=:id ";
                                            $result=$connect->prepare($sql);
                                            $result->bindvalue(":id",$id);
                                            $result->execute();
                                            $i = 0;
                                            while($fetch=$result->fetch(PDO::FETCH_ASSOC)){$i++;
                                            ?>
                                            <tr>
                                                <td><?= $i ?></td>
                                                <td>
                                                    <span><?= $fetch['mount'] ?></span>
                                                </td>
                                                <td class="hidden-xs">
                                                    <span><?= $fetch['date'] ?></span>
                                                </td>
                                                <td class="hidden-xs">
                                                    <span><?= $fetch['realname'] ?></span>
                                                </td>
                                                <td class="hidden-xs">
                                                    <span><?= $fetch['account'] ?></span>
                                                </td>
                                                <td>
                                                    <span><?php if(($fetch['shaba'])=='' || (!isset($fetch['shaba']))){echo "ثبت نشده";}else{echo $fetch['shaba'];} ?></span>
                                                </td>
                                                <td>
                                                <?php
                                                    if ($fetch['status'] == 0) {
                                                        echo "<span class='label label-warning'>در انتظار تایید</span><a href='delete.php?delete=".$fetch['id']."' class='btn btn-xs btn-danger' data-toggle='tooltip' data-placement='bottom' title='حذف'><i class='fa fa-trash'></i></a>";
                                                    }elseif ($fetch['status'] == 1) {
                                                        echo "<span class='label label-success'>پرداخت شده</span>";
                                                    }else{
                                                        echo "<span class='label label-danger'>خطای شماره شیا</span>";
                                                    }
                                                ?>
                                                </td>
...
<div id = "myModal" class="modal fade in" data-keyboard="false" data-backdrop="static">
   ...
   <div class = "modal-dialog">
      <form role="form" method="post" action="addcard.php" class = "modal-content">
         ...
         <div class = "modal-body">
            ...
            <small>کاربر گرامی لطفا در ورود اطلاعات دقت نمایید ، شما فقط یکبار میتوانید اطلاعات حساب خود را تکمیل نمایید .</small>
            <br>
            <div style="margin-top: 30px;">
                <fieldset >
                    <div class='form-group rtl'>
                        <label for=''>نام و نام خوانوادگی*</label>
                        <input name='RealName' class='form-control' id='' type='text' style='width: 100%' placeholder='نام و نام خوانوادگی خود را وارد نمایید * ' >
                    </div>
                    <div class='form-group rtl'>
                        <label for=''>شماره کارت *</label>
                        <input name='Account' class='form-control' id='' type='text' style='width: 100%' placeholder='شماره کارت حساب خود را وارد نمایید * ' >
                    </div>
                    <div class='form-group rtl'>
                        <label for=''>شماره شبا (اختیاری) </label>
                        <input name='Shaba' class='form-control' id='' type='text' style='width: 100%' placeholder='شماره شبا حساب خود را وارد نمایید (اختیاری) ' >
                    </div>
                </fieldset>
            </div>
         </div>
         <div class = "modal-footer">
            ...
            <input type="submit" name="btn" class = "btn btn-primary" style="width: auto !important" value="ذخیره اطلاعات حساب">
         </div>
