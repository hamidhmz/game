            ...
            <div class="navbar-default sidebar " >
                ...
                <div class="sidebar-nav  " >
                    <ul class="nav" id="">
                        ...
                        <li>
                            <a href="../help" class="active" data-toggle = "tooltip" data-placement = "bottom" title = "Game instructions"><i class="fa fa-life-ring fa-fw"></i> آموزش </a>
                        </li>
                        <li>
                    ...
                    <div class="panel panel-default">
                            ...
                            <div class="navbar-default in-xs sidebar" role="navigation">
                                <div class="sidebar-nav navbar-collapse">
                                    <ul class="nav" id="">
                                        ...
                                        <li>
                                            <a href="" class="active" data-toggle = "tooltip" data-placement = "bottom" title = " info"><i class="fa fa-phone fa-fw"></i>  آموزش بازی با ماونز</a>

                                        </li>
                                        <li>
                                            <a href="poker/"  data-toggle = "tooltip" data-placement = "bottom" title = " Rack Back "><i class="fa fa-send-o fa-fw"></i>  آموزش پوکر </a>
                        ...
                        <div class="" style="padding: 5px">
                             ...
                             <p style="direction: rtl;">
                                <?php
                                $sql1="select * from topic where id=3;";
                                $result1=$connect->prepare($sql1);
                                $result1->execute();
                                $fetch1=$result1->fetch(PDO::FETCH_ASSOC);
                                echo $fetch1['text'];
