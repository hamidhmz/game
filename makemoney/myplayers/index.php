                             ...
                             <div class="navbar-default sidebar" role="navigation">
                                <div class="sidebar-nav navbar-collapse">
                                    <ul class="nav" id="">
                                        ...
                                        <li>
                                            <a href="../rackback/"  data-toggle = "tooltip" data-placement = "bottom" title = " Rack Back "><i class="fa fa-money fa-fw"></i>  پورسات ها</a>
                                           
                                        </li>
                                        <li>
                                            <a href="../myplayers/" class="active" data-toggle = "tooltip" data-placement = "bottom" title = "My Player"><i class="fa fa-table fa-fw"></i>  زیرمجموعه های من</a>
                                        </li>
                                        <li>
                                                    ...
                                                    <table id="dynamic-table" class="bordered striped responsive-table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="" class="btn btn-xs btn-danger" data-toggle = "tooltip" data-placement = "bottom" title = "حذف"><i class="fa fa-trash"></i></a>
                                                                    <a href="" class="btn btn-xs btn-warning" data-toggle = "tooltip" data-placement = "bottom" title = "معلغ کردن"><i class="fa fa-cogs"></i></a>
                                                                    <a href="" class="btn btn-xs btn-success" data-toggle = "tooltip" data-placement = "bottom" title = "فعال کردن"><i class="fa fa-check"></i></a>
                                                                </td>
